...
typedef enum : nadir_u8_t {
    ...
    NADIR_COMPTIME_KIND_POPCNT,
    NADIR_COMPTIME_KIND_BSWAP,
    NADIR_COMPTIME_KIND_MASK,
    NADIR_COMPTIME_KIND_INSERT,
    NADIR_COMPTIME_KIND_EXTRACT,
    NADIR_COMPTIME_KIND_ROTL,
    NADIR_COMPTIME_KIND_ROTR,
